...
### v1.0.2 (2026-03-19) ⭐ Current

**配置优化**:
- ✅ Redis 配置优先级优化（环境变量 > pluginConfig > 默认值）
- ✅ 支持 `REDIS_HOST`, `REDIS_PORT`, `REDIS_URL`, `REDIS_PASSWORD`, `REDIS_DB` 环境变量
- ✅ 密码脱敏日志（隐藏 URL 中的密码）

**Event Handlers**:
- ✅ 支持 `write` 工具的文件路径提取

详见 [MILESTONE-v1.0.2.md](./MILESTONE-v1.0.2.md)
