...
export interface AccountContext {
  ...
  getStatus: () => any;
  setStatus: (status: { running: boolean }) => void;
}
...
export interface ChannelPlugin {
  ...
  setup?: {
    resolveAccountId?: (params: { cfg: any; accountId?: string }) => string;
    applyAccountName?: (params: { cfg: any; accountId: string; name?: string }) => any;
    applyAccountConfig: (params: { cfg: any; accountId: string; input: any }) => any;
    validateInput?: (params: { cfg: any; accountId: string; input: any }) => string | null;
  };
  status?: (ctx: AccountContext) => Promise<{ ok: boolean; message?: string }>;
}
...
export interface PluginContext {
  ...
  registerHttpRoute?: (params: {
    ...
    handler: (req: {
      ...
      status: (code: number) => { json: (data: any) => void; send: (data: string) => void; end: () => void };
    }) => void | Promise<void>;
  }) => { unregister: () => void };
}
